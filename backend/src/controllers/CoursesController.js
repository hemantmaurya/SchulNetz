...
export const coursesSave = async (req, res) => {
    ...
    try {
        const result = await pool.query(
            "INSERT INTO courses (name, course_name, description) VALUES ($1, $2, $3) RETURNING *",
...
export const coursesUpdate = async (req, res) => {
    ...
    try {
        const result = await pool.query(
            "UPDATE courses SET name = $1, course_name = $2, description = $3, updated_at = CURRENT_TIMESTAMP WHERE id = $4 RETURNING *",
