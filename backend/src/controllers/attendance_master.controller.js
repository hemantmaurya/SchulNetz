...
export const createAttendanceMaster = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({
            success: true,
            message: "Attendance master record created successfully!",
            data: result.rows[0]
        });
    } catch (error) {
        console.error(error);
...
// READ - Get Single Attendance Master by ID
export const getAttendanceMasterById = async (req, res) => {
    ...
    try {
        ...
        if (result.rows.length === 0) {
            return res.status(404).json({ success: false, message: "Attendance master record not found" });
        }
...
export const updateAttendanceMaster = async (req, res) => {
    ...
    try {
        ...
        res.json({
            success: true,
            message: "Attendance master updated successfully!",
            data: result.rows[0]
        });
    } catch (error) {
        console.error(error);
